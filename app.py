...
with open("cleveland.data", encoding='Latin1') as file:
...
# fungsi drop
# karena tdk didominasi oleh missing value maka tdk perlu lakukan drop (penghapusan)
...
dfClean = dfClean.drop_duplicates() # tamba (inplace=True), jika error
...
st.set_page_config(
  page_title = "Cleveland Heart Disease Prediction",
  page_icon = ":butterfly:"
)

st.title("Cleveland Heart Disease Prediction")
